        ...
        <div id="body1" class="show" name="divcontent">
            <dl class="content">
                ...
                <dt>订单名称
                    ：</dt>
                <dd>
                    <input  name="WIDsubject" value="{{$name}}" />
                </dd>
                <hr class="one_line">
                <dt>付款金额
                    ：</dt>
                <dd>
                    <input id="WIDtotal_amount" name="WIDtotal_amount" value="{{$money}}.00" style="color: red" />
                </dd>
                <hr class="one_line">
                <dt>商品描述：</dt>
                <dd>
                    <input id="WIDbody" name="WIDbody" value="{{$detail}}" />
                </dd>
                <hr class="one_line">
                <dt></dt>
                <dd id="btn-dd">
